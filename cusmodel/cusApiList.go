...
func (CustomerApiList) TableName() string { return "customer_api_list" }
...
func regSysApiListTable() error {
	...
	return db.Db.AutoMigrate(&CustomerApiList{})
}

func (a *CustomerApiList) Add() error {
	err := db.Db.Create(a).Error
	return err
}

// AddIfNotExists: 若接口(route+method)不存在则插入
func (a *CustomerApiList) AddIfNotExists() error {
	var exist CustomerApiList
