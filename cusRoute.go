...
func CusRouteInit() {
	...
	roootRouter.NewesysCusRouter(r)
}

func NewCusRoute(path string, handlers ...gin.HandlerFunc) *gin.RouterGroup {
	r := Route.Group(path, handlers...)
	return r
}

func CusCors() gin.HandlerFunc {
